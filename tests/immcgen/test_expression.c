...
void test_immcgen_conditional_expr(void);
void test_immcgen_conditional_expr_chain(void);
void test_immcgen_logical_or_expr(void);
void test_immcgen_logical_and_expr(void);
void test_immcgen_bitwise_inclusive_or_expr(void);
void test_immcgen_bitwise_exclusive_or_expr(void);
void test_immcgen_bitwise_and_expr(void);
void test_immcgen_equal_expr(void);
void test_immcgen_not_equal_expr(void);
void test_immcgen_less_expr(void);
void test_immcgen_greater_expr(void);
void test_immcgen_less_equal_expr(void);
void test_immcgen_greater_equal_expr(void);
void test_immcgen_lshift_expr(void);
void test_immcgen_rshift_expr(void);
...
void test_immcgen_preinc_expr_signed(void);
void test_immcgen_preinc_expr_unsigned(void);
void test_immcgen_preinc_expr_completed_pointer(void);
void test_immcgen_preinc_expr_void_pointer(void);
void test_immcgen_predec_expr_signed(void);
void test_immcgen_predec_expr_unsigned(void);
void test_immcgen_predec_expr_completed_pointer(void);
void test_immcgen_predec_expr_void_pointer(void);
...
void test_immcgen_positive_expr(void);
void test_immcgen_negative_expr(void);
void test_immcgen_bitwise_not_expr(void);
...
void test_immcgen_postinc_expr_signed(void);
void test_immcgen_postinc_expr_unsigned(void);
void test_immcgen_postinc_expr_completed_pointer(void);
void test_immcgen_postinc_expr_void_pointer(void);
void test_immcgen_postdec_expr_signed(void);
void test_immcgen_postdec_expr_unsigned(void);
void test_immcgen_postdec_expr_completed_pointer(void);
void test_immcgen_postdec_expr_void_pointer(void);
void test_immcgen_ident_expr_local(void);
void test_immcgen_ident_expr_global(void);
void test_immcgen_string_expr(void);
...
CU_Suite* add_test_suite_expr_immcgen(void) {
    ...
    CU_ADD_TEST(suite, test_immcgen_conditional_expr);
    CU_ADD_TEST(suite, test_immcgen_conditional_expr_chain);
    CU_ADD_TEST(suite, test_immcgen_logical_or_expr);
    CU_ADD_TEST(suite, test_immcgen_logical_and_expr);
    CU_ADD_TEST(suite, test_immcgen_bitwise_inclusive_or_expr);
    CU_ADD_TEST(suite, test_immcgen_bitwise_exclusive_or_expr);
    CU_ADD_TEST(suite, test_immcgen_bitwise_and_expr);
    CU_ADD_TEST(suite, test_immcgen_equal_expr);
    CU_ADD_TEST(suite, test_immcgen_not_equal_expr);
    CU_ADD_TEST(suite, test_immcgen_less_expr);
    CU_ADD_TEST(suite, test_immcgen_greater_expr);
    CU_ADD_TEST(suite, test_immcgen_less_equal_expr);
    CU_ADD_TEST(suite, test_immcgen_greater_equal_expr);
    CU_ADD_TEST(suite, test_immcgen_lshift_expr);
    CU_ADD_TEST(suite, test_immcgen_rshift_expr);
    ...
    CU_ADD_TEST(suite, test_immcgen_preinc_expr_signed);
    CU_ADD_TEST(suite, test_immcgen_preinc_expr_unsigned);
    CU_ADD_TEST(suite, test_immcgen_preinc_expr_completed_pointer);
    CU_ADD_TEST(suite, test_immcgen_preinc_expr_void_pointer);
    CU_ADD_TEST(suite, test_immcgen_predec_expr_signed);
    CU_ADD_TEST(suite, test_immcgen_predec_expr_unsigned);
    CU_ADD_TEST(suite, test_immcgen_predec_expr_completed_pointer);
    CU_ADD_TEST(suite, test_immcgen_predec_expr_void_pointer);
    ...
    CU_ADD_TEST(suite, test_immcgen_positive_expr);
    CU_ADD_TEST(suite, test_immcgen_negative_expr);
    CU_ADD_TEST(suite, test_immcgen_bitwise_not_expr);
    ...
    CU_ADD_TEST(suite, test_immcgen_postinc_expr_signed);
    CU_ADD_TEST(suite, test_immcgen_postinc_expr_unsigned);
    CU_ADD_TEST(suite, test_immcgen_postinc_expr_completed_pointer);
    CU_ADD_TEST(suite, test_immcgen_postinc_expr_void_pointer);
    CU_ADD_TEST(suite, test_immcgen_postdec_expr_signed);
    CU_ADD_TEST(suite, test_immcgen_postdec_expr_unsigned);
    CU_ADD_TEST(suite, test_immcgen_postdec_expr_completed_pointer);
    CU_ADD_TEST(suite, test_immcgen_postdec_expr_void_pointer);
    CU_ADD_TEST(suite, test_immcgen_ident_expr_local);
    CU_ADD_TEST(suite, test_immcgen_ident_expr_global);
    CU_ADD_TEST(suite, test_immcgen_string_expr);
...
void test_immcgen_assignment_expr(void) {
    ...
    Srt* input = new_dtyped_srt(
        ...
        new_dtyped_srt(
            ...
            new_dtyped_srt(SRT_ASSIGN_EXPR, dtype_copy(int_dtype), 2,                                 // non-terminal
...
void test_immcgen_conditional_expr(void) {
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_LOAD,                              // inst
                              ...
                              NULL));                                      // snd_src
    vector_push(expected,
                new_inst_immc(IMMC_INST_JLT,                                              // inst
...
void test_immcgen_conditional_expr_chain(void) {
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_LOAD,                                           // inst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 7),              // dst
                              new_signed_int_immcope(IMMC_SUFFIX_LONG, INTEGER_INT, 0), // fst_src
                              NULL));                                                   // snd_src
    vector_push(expected,
                new_inst_immc(IMMC_INST_LOAD,                              // inst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 4), // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 7), // fst_src
                              NULL));                                      // snd_src
...
void test_immcgen_logical_and_expr(void) {
    ...
    Srt* input = new_dtyped_srt(
        ...
        new_dtyped_srt(SRT_NEQUAL_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
...
void test_immcgen_less_expr(void) {
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_SETLT,                               // inst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 3),   // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 0),   // fst_src
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 2))); // snd_src
...
void test_immcgen_greater_expr(void) {
    Srt* input = new_dtyped_srt(SRT_GREATER_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
...
void test_immcgen_greater_equal_expr(void) {
    Srt* input = new_dtyped_srt(SRT_GREATEREQ_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
                                new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_INT), new_string("j")),
                                new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_signed_iliteral(INTEGER_INT, 0)));
...
void test_immcgen_lshift_expr(void) {
    Srt* input = new_dtyped_srt(
        SRT_LSHIFT_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 2, // non-terminal
        new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), new_string("n")),
    ...
    SymbolTable* local_table = new_symboltable();
    symboltable_define_memory(local_table, new_string("n"), new_integer_dtype(DTYPE_UNSIGNED_INT));
...
void test_immcgen_rshift_expr(void) {
    Srt* input = new_dtyped_srt(SRT_RSHIFT_EXPR, new_integer_dtype(DTYPE_LONG), 2, // non-terminal
                                new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_LONG), new_string("m")),
                                new_iliteral_srt(new_integer_dtype(DTYPE_LONG), new_signed_iliteral(INTEGER_LONG, 2l)));

    SymbolTable* local_table = new_symboltable();
    symboltable_define_memory(local_table, new_string("m"), new_integer_dtype(DTYPE_LONG));
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_SAR,                                                // inst
                              ...
                              new_signed_int_immcope(IMMC_SUFFIX_QUAD, INTEGER_LONG, 2l))); // snd_src
...
void test_immcgen_signed_multiply_expr(void) {
    Srt* input = new_dtyped_srt(SRT_MUL_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
                                new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_signed_iliteral(INTEGER_INT, 4)),
...
void test_immcgen_unsigned_multiply_expr(void) {
    Srt* input = new_dtyped_srt(
        ...
        new_dtyped_srt(
            SRT_MUL_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 2, // non-terminal
            new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 3u)),
            new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 5u))),
        new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 2u)));
...
void test_immcgen_unsigned_division_expr(void) {
    Srt* input = new_dtyped_srt(
        SRT_SUB_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 2, // non-terminal
        new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 34u)),
        new_dtyped_srt(
            SRT_DIV_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 2, // non-terminal
            new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 18u)),
            new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 4u))));
...
void test_immcgen_unsigned_modulo_expr(void) {
    Srt* input = new_dtyped_srt(
        ...
        new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_LONG), new_unsigned_iliteral(INTEGER_UNSIGNED_LONG, 4ul)));
...
void test_immcgen_preinc_expr_unsigned(void) {
    DType* array_dtype = new_array_dtype(new_integer_dtype(DTYPE_UNSIGNED_INT), 5);
    DType* pointer_dtype = new_pointer_dtype(new_integer_dtype(DTYPE_UNSIGNED_INT));

    Srt* input = new_dtyped_srt(
        SRT_PREINC_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1, // non-terminal
        new_dtyped_srt(
            SRT_ADDR_EXPR, dtype_copy(pointer_dtype), 1, // non-terminal
            new_dtyped_srt(
                SRT_INDIR_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1, // non-terminal
                new_dtyped_srt(
                    SRT_PADD_EXPR, dtype_copy(pointer_dtype), 2,    // non-terminal
                    new_dtyped_srt(SRT_ADDR_EXPR, pointer_dtype, 1, // non-terminal
                                   new_identifier_srt(SRT_IDENT_EXPR, dtype_copy(array_dtype), new_string("a"))),
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_ADD,                                                          // inst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 3),                          // dst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 3),                          // fst_src
...
void test_immcgen_preinc_expr_completed_pointer(void) {
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_ADD,                                              // inst
                              new_signed_reg_immcope(IMMC_SUFFIX_QUAD, 0),                // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_QUAD, 0),                // fst_src
                              new_signed_int_immcope(IMMC_SUFFIX_QUAD, INTEGER_INT, 1))); // snd_src
    vector_push(expected,
                new_inst_immc(IMMC_INST_STORE,                             // inst
...
void test_immcgen_preinc_expr_void_pointer(void) {
    DType* pointer_dtype = new_pointer_dtype(new_void_dtype());

    Srt* input =
        new_dtyped_srt(SRT_PREINC_EXPR, dtype_copy(pointer_dtype), 1,                                 // non-terminal
                       new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(dtype_copy(pointer_dtype)), 1, // non-terminal
                                      new_identifier_srt(SRT_IDENT_EXPR, dtype_copy(pointer_dtype), new_string("v"))));

    SymbolTable* local_table = new_symboltable();
    symboltable_define_memory(local_table, new_string("v"), pointer_dtype);
...
void test_immcgen_predec_expr_unsigned(void) {
    Srt* input = new_dtyped_srt(
        SRT_PREDEC_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1,                                 // non-terminal
        new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(new_integer_dtype(DTYPE_UNSIGNED_INT)), 1, // non-terminal
                       new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), new_string("j"))));

    SymbolTable* local_table = new_symboltable();
    symboltable_define_memory(local_table, new_string("j"), new_integer_dtype(DTYPE_UNSIGNED_INT));
...
void test_immcgen_predec_expr_completed_pointer(void) {
    DType* pointer_dtype = new_pointer_dtype(new_integer_dtype(DTYPE_LONG));
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_SUB,                                              // inst
                              new_signed_reg_immcope(IMMC_SUFFIX_QUAD, 0),                // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_QUAD, 0),                // fst_src
                              new_signed_int_immcope(IMMC_SUFFIX_QUAD, INTEGER_INT, 8))); // snd_src
    vector_push(expected,
                new_inst_immc(IMMC_INST_STORE,                             // inst
                              new_mem_immcope(8),                          // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_QUAD, 0), // fst_src
...
void test_immcgen_bitwise_not_expr(void) {
    Srt* input = new_dtyped_srt(SRT_NOT_EXPR, new_integer_dtype(DTYPE_INT), 1, // non-terminal
                                new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_INT), new_string("x")));
...
void test_immcgen_postinc_expr_unsigned(void) {
    Srt* input = new_dtyped_srt(
        SRT_POSTINC_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1,                                // non-terminal
        new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(new_integer_dtype(DTYPE_UNSIGNED_INT)), 1, // non-terminal
                       new_identifier_srt(SRT_IDENT_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), new_string("i"))));

    SymbolTable* local_table = new_symboltable();
    symboltable_define_memory(local_table, new_string("i"), new_integer_dtype(DTYPE_UNSIGNED_INT));
...
void test_immcgen_postdec_expr_unsigned(void) {
    ...
    Srt* input = new_dtyped_srt(
        SRT_POSTDEC_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1, // non-terminal
        new_dtyped_srt(
            SRT_ADDR_EXPR, dtype_copy(pointer_dtype), 1, // non-terminal
            new_dtyped_srt(
                SRT_INDIR_EXPR, new_integer_dtype(DTYPE_UNSIGNED_INT), 1, // non-terminal
    ...
    vector_push(expected,
                new_inst_immc(IMMC_INST_LOAD,                                // inst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 4), // dst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 3), // fst_src
                              NULL));                                        // snd_src
    vector_push(expected,
                new_inst_immc(IMMC_INST_SUB,                                                          // inst
...
void test_immcgen_string_expr(void) {
    Srt* input = new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(new_integer_dtype(DTYPE_CHAR)), 1, // non-terminal
                                new_string_srt(SRT_STR_EXPR, new_array_dtype(new_integer_dtype(DTYPE_CHAR), 6), 0));
...
void test_immcgen_iliteral_expr_char(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_signed_iliteral(INTEGER_INT, 89));
...
void test_immcgen_iliteral_expr_int(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_signed_iliteral(INTEGER_INT, 3));
...
void test_immcgen_iliteral_expr_unsigned_int(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_unsigned_iliteral(INTEGER_UNSIGNED_INT, 5u));
...
void test_immcgen_iliteral_expr_long(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_LONG), new_signed_iliteral(INTEGER_LONG, 7l));
...
void test_immcgen_iliteral_expr_unsigned_long(void) {
    Srt* input =
        new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_LONG), new_unsigned_iliteral(INTEGER_UNSIGNED_LONG, 11ul));
...
void test_immcgen_iliteral_expr_long_long(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_LONGLONG), new_signed_iliteral(INTEGER_LONGLONG, 13ll));
...
void test_immcgen_iliteral_expr_unsigned_long_long(void) {
    Srt* input = new_iliteral_srt(new_integer_dtype(DTYPE_UNSIGNED_LONGLONG),
