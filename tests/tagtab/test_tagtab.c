...
void test_tagtable_define_struct(void) {
    ...
    CU_ASSERT_TRUE(tagtable_can_define(table, struct_name));
...
void test_tagtable_duplicated_struct(void) {
    ...
    CU_ASSERT_FALSE(tagtable_can_define(table, dup_name));

    struct_dtype = tagtable_define_struct(table, dup_name, dup_members);
    CU_ASSERT_PTR_NULL(struct_dtype);

    struct_dtype = tagtable_search(table, dup_name);
    CU_ASSERT_TRUE(dtype_equals(struct_dtype, expected_struct_dtype));
...
void test_tagtable_scoped_struct(void) {
    ...
    CU_ASSERT_TRUE(tagtable_can_define(table, outer_both_name));
    ...
    CU_ASSERT_TRUE(tagtable_can_define(table, inner_both_name));
    ...
    struct_dtype = tagtable_search(table, inner_name);
    CU_ASSERT_TRUE(dtype_equals(struct_dtype, expected_inner_dtype));

    struct_dtype = tagtable_search(table, inner_both_name);
...
void test_tagtable_copy_without_outer(void) {
    ...
    copied_dtype = tagtable_search(copied_table, enum_name);
    CU_ASSERT_TRUE(dtype_equals(copied_dtype, expected_enum_dtype));
    free(enum_name);

    struct_name = new_string("Struct");
    copied_dtype = tagtable_search(copied_table, struct_name);
...
void test_tagtable_copy_with_outer(void) {
    ...
    copied_dtype = tagtable_search(copied_table, outer_enum_name);
    ...
    copied_dtype = tagtable_search(copied_table, inner_enum_name);
...
void test_tagtable_define_enum(void) {
    ...
    CU_ASSERT_TRUE(tagtable_can_define(table, enum_name));
...
void test_tagtable_duplicated_enum(void) {
    ...
    enum_dtype = tagtable_search(table, dup_name);
    CU_ASSERT_TRUE(dtype_equals(enum_dtype, expected_enum_dtype));
...
void test_tagtable_scoped_enum(void) {
    ...
    enum_dtype = tagtable_search(table, outer_name);
    CU_ASSERT_TRUE(dtype_equals(enum_dtype, expected_outer_dtype));

    enum_dtype = tagtable_search(table, inner_name);
    CU_ASSERT_TRUE(dtype_equals(enum_dtype, expected_inner_dtype));

    enum_dtype = tagtable_search(table, inner_both_name);
    ...
    enum_dtype = tagtable_search(table, "InnerEnum");
    CU_ASSERT_PTR_NULL(enum_dtype);

    enum_dtype = tagtable_search(table, outer_both_name);
