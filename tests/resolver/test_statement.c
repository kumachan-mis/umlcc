...
void test_resolve_case_stmt(void);
void test_resolve_default_stmt(void);
...
void test_resolve_switch_stmt_int_iliteral(void);
void test_resolve_switch_stmt_various_iliteral(void);
...
CU_Suite* add_test_suite_stmt_resolver(void) {
    ...
    CU_ADD_TEST(suite, test_resolve_case_stmt);
    CU_ADD_TEST(suite, test_resolve_default_stmt);
    ...
    CU_ADD_TEST(suite, test_resolve_switch_stmt_int_iliteral);
    CU_ADD_TEST(suite, test_resolve_switch_stmt_various_iliteral);
    CU_ADD_TEST(suite, test_resolve_switch_stmt_enum);
...
void test_resolve_compound_stmt_incompleted_typedef(void) {
    ...
    Srt* expected = new_srt(
        ...
        new_srt(SRT_DECL_LIST, 1,         // non-terminal
                new_srt(SRT_INIT_DECL, 1, // non-terminal
                        new_identifier_srt(SRT_IDENT_DECL, new_typedef_dtype(incomplete_unnamed_struct_dtype),
                                           new_string("Struct")))),
        ...
        new_srt(
            ...
            new_srt(
                ...
                new_identifier_srt(SRT_IDENT_DECL, new_pointer_dtype(complete_unnamed_struct_dtype), new_string("s")),
...
void test_resolve_continue_stmt(void) {
    ...
    Srt* expected = new_srt(SRT_WHILE_STMT, 2, // non-terminal
                            new_iliteral_srt(new_integer_dtype(DTYPE_INT), new_signed_iliteral(INTEGER_INT, 1)),
    ...
    Srt* expected =
        new_srt(SRT_RET_STMT, 1,                                                                   // non-terminal
                new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(new_integer_dtype(DTYPE_CHAR)), 1, // non-terminal
                               new_string_srt(SRT_STR_EXPR, new_array_dtype(new_integer_dtype(DTYPE_CHAR), 7), 0)));
...
void test_resolve_expression_stmt_array(void) {
    ...
    Srt* expected =
        new_srt(SRT_EXPR_STMT, 1,                                                                  // non-terminal
                new_dtyped_srt(SRT_ADDR_EXPR, new_pointer_dtype(new_integer_dtype(DTYPE_CHAR)), 1, // non-terminal
                               new_string_srt(SRT_STR_EXPR, new_array_dtype(new_integer_dtype(DTYPE_CHAR), 11), 0)));
...
void test_resolve_switch_stmt_various_iliteral(void) {
    Ast* input =
        new_ast(AST_SWITCH_STMT, 2, // non-terminal
                new_identifier_ast(AST_IDENT_EXPR, new_string("x")),
                new_ast(AST_CMPD_STMT, 8,
                        new_ast(AST_CASE_STMT, 2, // non-terminal
                                new_iliteral_ast(AST_INT_EXPR, new_signed_iliteral(INTEGER_LONG, 0L)),
                                new_ast(AST_EXPR_STMT, 1,           // non-terminal
                                        new_ast(AST_ASSIGN_EXPR, 2, // non-terminal
                                                new_identifier_ast(AST_IDENT_EXPR, new_string("y")),
                                                new_iliteral_ast(AST_INT_EXPR, new_signed_iliteral(INTEGER_INT, 1))))),
                        ...
                        new_ast(AST_BREAK_STMT, 0),
                        new_ast(AST_CASE_STMT, 2, // non-terminal
                                new_iliteral_ast(AST_INT_EXPR, new_signed_iliteral(INTEGER_LONGLONG, 1LL)),
                                new_ast(AST_EXPR_STMT, 1,           // non-terminal
                                        new_ast(AST_ASSIGN_EXPR, 2, // non-terminal
                                                new_identifier_ast(AST_IDENT_EXPR, new_string("y")),
                                                new_iliteral_ast(AST_INT_EXPR, new_signed_iliteral(INTEGER_INT, 2))))),
    ...
    Srt* expected = new_srt(
        ...
        new_srt(
            SRT_CMPD_STMT, 8,         // non-terminal
            new_srt(SRT_CASE_STMT, 2, // non-terminal
                    new_iliteral_srt(new_integer_dtype(DTYPE_LONG), new_signed_iliteral(INTEGER_LONG, 0L)),
                    new_srt(SRT_EXPR_STMT, 1, // non-terminal
                            new_dtyped_srt(
                                SRT_ASSIGN_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
                                new_dtyped_srt(
            ...
            new_srt(SRT_BREAK_STMT, 0),
            new_srt(SRT_CASE_STMT, 2, // non-terminal
                    new_iliteral_srt(new_integer_dtype(DTYPE_LONGLONG), new_signed_iliteral(INTEGER_LONGLONG, 1LL)),
                    new_srt(SRT_EXPR_STMT, 1, // non-terminal
                            new_dtyped_srt(
                                SRT_ASSIGN_EXPR, new_integer_dtype(DTYPE_INT), 2, // non-terminal
                                new_dtyped_srt(
...
void test_resolve_switch_stmt_enum(void) {
    ...
    iliteral = new_signed_iliteral(INTEGER_INT, 0);
    symboltable_define_integer(local_table, new_string("A"), new_integer_dtype(DTYPE_INT), iliteral);
    iliteral = new_signed_iliteral(INTEGER_INT, 1);
    symboltable_define_integer(local_table, new_string("B"), new_integer_dtype(DTYPE_INT), iliteral);
    iliteral = new_signed_iliteral(INTEGER_INT, 2);
    symboltable_define_integer(local_table, new_string("C"), new_integer_dtype(DTYPE_INT), iliteral);
    iliteral = new_signed_iliteral(INTEGER_INT, 3);
    symboltable_define_integer(local_table, new_string("D"), new_integer_dtype(DTYPE_INT), iliteral);
