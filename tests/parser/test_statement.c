...
void test_parse_compound_stmt_with_items();
void test_parse_compound_stmt_without_items();
...
CU_Suite* add_test_suite_stmt_parser() {
    ...
    CU_ADD_TEST(suite, test_parse_compound_stmt_with_items);
    CU_ADD_TEST(suite, test_parse_compound_stmt_without_items);
