...
void test_x64gen_jeq_reg_int_signed(void);
void test_x64gen_jeq_reg_reg_singed(void);
void test_x64gen_jeq_reg_int_unsigned(void);
void test_x64gen_jeq_reg_reg_unsinged(void);
void test_x64gen_jneq_reg_int_signed(void);
void test_x64gen_jneq_reg_reg_signed(void);
void test_x64gen_jneq_reg_int_unsigned(void);
void test_x64gen_jneq_reg_reg_unsigned(void);
void test_x64gen_jgt_reg_int_signed(void);
void test_x64gen_jgt_reg_reg_singed(void);
void test_x64gen_jgt_reg_int_unsigned(void);
void test_x64gen_jgt_reg_reg_unsinged(void);
void test_x64gen_jgeq_reg_int_signed(void);
void test_x64gen_jgeq_reg_reg_signed(void);
void test_x64gen_jgeq_reg_int_unsigned(void);
void test_x64gen_jgeq_reg_reg_unsigned(void);
void test_x64gen_jlt_reg_int_signed(void);
void test_x64gen_jlt_reg_reg_singed(void);
void test_x64gen_jlt_reg_int_unsigned(void);
void test_x64gen_jlt_reg_reg_unsinged(void);
void test_x64gen_jleq_reg_int_signed(void);
void test_x64gen_jleq_reg_reg_signed(void);
void test_x64gen_jleq_reg_int_unsigned(void);
void test_x64gen_jleq_reg_reg_unsigned(void);
...
CU_Suite* add_test_suite_ctrlinst_x64gen(void) {
    ...
    CU_ADD_TEST(suite, test_x64gen_jeq_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jeq_reg_reg_singed);
    CU_ADD_TEST(suite, test_x64gen_jeq_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jeq_reg_reg_unsinged);
    CU_ADD_TEST(suite, test_x64gen_jneq_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jneq_reg_reg_signed);
    CU_ADD_TEST(suite, test_x64gen_jneq_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jneq_reg_reg_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jgt_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jgt_reg_reg_singed);
    CU_ADD_TEST(suite, test_x64gen_jgt_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jgt_reg_reg_unsinged);
    CU_ADD_TEST(suite, test_x64gen_jgeq_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jgeq_reg_reg_signed);
    CU_ADD_TEST(suite, test_x64gen_jgeq_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jgeq_reg_reg_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jlt_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jlt_reg_reg_singed);
    CU_ADD_TEST(suite, test_x64gen_jlt_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jlt_reg_reg_unsinged);
    CU_ADD_TEST(suite, test_x64gen_jleq_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_jleq_reg_reg_signed);
    CU_ADD_TEST(suite, test_x64gen_jleq_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_jleq_reg_reg_unsigned);
...
void test_x64gen_jeq_reg_int_unsigned(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             new_unsigned_int_x64ope(X64_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 4u), // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JE,                              // inst
                             NULL,                                     // src
...
void test_x64gen_jneq_reg_int_unsigned(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_JNEQ,                                                         // inst
                              ...
                              new_unsigned_int_immcope(IMMC_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 8u))); // snd_src
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             new_unsigned_int_x64ope(X64_SUFFIX_QUAD, INTEGER_UNSIGNED_INT, 8u), // src
                             new_reg_x64ope(X64_SUFFIX_QUAD, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JNE,                             // inst
                             NULL,                                     // src
...
void test_x64gen_jneq_reg_reg_unsigned(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_LOAD,                                // inst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_BYTE, 1), // dst
                              new_mem_immcope(8),                            // fst_src
                              NULL));                                        // snd_src
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_JNEQ,                                  // inst
                              new_label_immcope(new_string("LABEL")),          // dst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 0),   // fst_src
                              new_unsigned_reg_immcope(IMMC_SUFFIX_BYTE, 1))); // snd_src
...
void test_x64gen_jgt_reg_int_unsigned(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             new_unsigned_int_x64ope(X64_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 5u), // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JA,                              // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jgeq_reg_int_signed(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                              // inst
                             new_signed_int_x64ope(X64_SUFFIX_LONG, INTEGER_INT, 6),     // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0]))); // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JGE,                             // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jgeq_reg_int_unsigned(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_JGEQ,                                                         // inst
                              new_label_immcope(new_string("LABEL")),                                 // dst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_BYTE, 0),                          // fst_src
                              new_unsigned_int_immcope(IMMC_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 6u))); // snd_src
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             new_unsigned_int_x64ope(X64_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 6u), // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JAE,                             // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jlt_reg_int_signed(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_JLT,                                              // inst
                              new_label_immcope(new_string("LABEL")),                     // dst
                              new_signed_reg_immcope(IMMC_SUFFIX_LONG, 0),                // fst_src
                              new_signed_int_immcope(IMMC_SUFFIX_LONG, INTEGER_INT, 7))); // snd_src
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                              // inst
                             new_signed_int_x64ope(X64_SUFFIX_LONG, INTEGER_INT, 7),     // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0]))); // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JL,                              // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jlt_reg_int_unsigned(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_JLT,                                                          // inst
                              new_label_immcope(new_string("LABEL")),                                 // dst
                              new_unsigned_reg_immcope(IMMC_SUFFIX_LONG, 0),                          // fst_src
                              new_unsigned_int_immcope(IMMC_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 7u))); // snd_src
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             new_unsigned_int_x64ope(X64_SUFFIX_LONG, INTEGER_UNSIGNED_INT, 7u), // src
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JB,                              // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jleq_reg_int_signed(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                              // inst
                             ...
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0]))); // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JLE,                             // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
...
void test_x64gen_jleq_reg_int_unsigned(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_CMPX,                                                      // inst
                             ...
                             new_reg_x64ope(X64_SUFFIX_LONG, CALLER_SAVED_REG_IDS[0])));         // dst
    vector_push(expected,
                new_inst_x64(X64_INST_JBE,                             // inst
                             NULL,                                     // src
                             new_jlabel_x64ope(new_string("LABEL")))); // dst
