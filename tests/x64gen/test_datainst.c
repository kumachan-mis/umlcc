...
void test_x64gen_store_int_ptr(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_MOVX,                                      // inst
                             new_signed_x64ope(X64_SUFFIX_LONG, INTEGER_INT, 8), // src
...
void test_x64gen_ldarg_sixth_or_less(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_LDARG,                      // inst
                              ...
                              new_arg_immcope(IMMC_SUFFIX_LONG, 5), // fst_src
                              NULL));                               // snd_src
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_LDARG,                      // inst
                              new_mem_immcope(20),                  // dst
                              new_arg_immcope(IMMC_SUFFIX_LONG, 4), // fst_src
                              NULL));                               // snd_src
...
void test_x64gen_ldarg_seventh_or_more(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_LDARG,                      // inst
                              ...
                              new_arg_immcope(IMMC_SUFFIX_QUAD, 6), // fst_src
                              NULL));                               // snd_src
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_LDARG,                      // inst
                              new_mem_immcope(36),                  // dst
                              new_arg_immcope(IMMC_SUFFIX_LONG, 7), // fst_src
                              NULL));                               // snd_src
...
void test_x64gen_starg_reg(void) {
    ...
    vector_push(input_immcs,
                new_inst_immc(IMMC_INST_STARG,                      // inst
                              new_arg_immcope(IMMC_SUFFIX_BYTE, 0), // dst
                              new_reg_immcope(IMMC_SUFFIX_BYTE, 0), // fst_src
                              NULL));                               // snd_src
...
void test_x64gen_stret_int(void) {
    ...
    vector_push(expected,
                new_inst_x64(X64_INST_MOVX,                                      // inst
                             new_signed_x64ope(X64_SUFFIX_LONG, INTEGER_INT, 5), // src
