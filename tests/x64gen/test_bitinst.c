...
void test_x64gen_sete_reg_int_signed(void);
void test_x64gen_sete_reg_reg_signed(void);
void test_x64gen_sete_reg_int_unsigned(void);
void test_x64gen_sete_reg_reg_unsigned(void);
void test_x64gen_setne_reg_int_signed(void);
void test_x64gen_setne_reg_reg_signed(void);
void test_x64gen_setne_reg_int_unsigned(void);
void test_x64gen_setne_reg_reg_unsigned(void);
...
CU_Suite* add_test_suite_bitinst_x64gen(void) {
    ...
    CU_ADD_TEST(suite, test_x64gen_sete_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_sete_reg_reg_signed);
    CU_ADD_TEST(suite, test_x64gen_sete_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_sete_reg_reg_unsigned);
    CU_ADD_TEST(suite, test_x64gen_setne_reg_int_signed);
    CU_ADD_TEST(suite, test_x64gen_setne_reg_reg_signed);
    CU_ADD_TEST(suite, test_x64gen_setne_reg_int_unsigned);
    CU_ADD_TEST(suite, test_x64gen_setne_reg_reg_unsigned);
    return suite;
}
