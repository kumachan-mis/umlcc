...
X64Ope* new_base_x64ope(X64OpeType type);

X64Ope* new_suffix_x64ope(X64Suffix suffix) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_SUFFIX);
    x64ope->suffix = suffix;
    return x64ope;
}

X64Ope* new_reg_x64ope(X64Suffix suffix, X64RegisterId reg_id) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_REG);
    x64ope->suffix = suffix;
...
X64Ope* new_ptr_x64ope(X64RegisterId reg_id) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_PTR);
...
X64Ope* new_jptr_x64ope(X64RegisterId reg_id) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_JPTR);
    x64ope->suffix = X64_SUFFIX_QUAD;
    x64ope->reg_id = reg_id;
    return x64ope;
}
...
X64Ope* new_signed_int_x64ope(X64Suffix suffix, IntegerLiteralType type, long long value) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_INT);
    x64ope->suffix = suffix;
    x64ope->iliteral = new_signed_iliteral(type, value);
    return x64ope;
}
...
X64Ope* new_unsigned_int_x64ope(X64Suffix suffix, IntegerLiteralType type, unsigned long long value) {
    X64Ope* x64ope = new_base_x64ope(X64_OPERAND_INT);
    x64ope->suffix = suffix;
    x64ope->iliteral = new_unsigned_iliteral(type, value);
    return x64ope;
}
...
char* x64ope_tostring(X64Ope* x64ope) {
    ...
    switch (x64ope->type) {
        ...
        case X64_OPERAND_MEM:
            sprintf(ope_str, "%d(%s)", -x64ope->mem_offset, reg_name(BP_REG_ID, X64_SUFFIX_QUAD));
            break;
