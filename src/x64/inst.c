...
char* x64_inst_formats[] = {"mov%c", "movs%c%c", "movabs%c", "lea%c",  "c%ct%c", "c%ctd",  "cqto",  "push%c",
                            "pop%c", "add%c",    "sub%c",    "imul%c", "div%c",  "idiv%c", "sal%c", "sar%c",
                            "cmp%c", "sete",     "setne",    "jmp",    "je",     "jne",    "call",  "ret"};
